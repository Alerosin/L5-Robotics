...
"""autogenerated by genpy from l5_robots/Obstacles.msg. Do not edit."""
import sys
...
class Obstacles(genpy.Message):
  _md5sum = "4091faabcc1f00827c0de46a68c91753"
  _type = "l5_robots/Obstacles"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32[] angles
float32[] distances
float32 max_range
"""
  __slots__ = ['angles','distances','max_range']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_f().pack(self.max_range))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.max_range,) = _get_struct_f().unpack(str[start:end])
      return self
